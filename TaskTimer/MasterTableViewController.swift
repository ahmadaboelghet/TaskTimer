...
class MasterTableViewController: UITableViewController {
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        var itemlistForUserDefaults : NSMutableArray? = userDefaults.objectForKey("itemlist") as? NSMutableArray
        
        if ((itemlistForUserDefaults) != nil){
            todoitems = itemlistForUserDefaults!
    ...
    */
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if (segue.identifier == "ahmad"){
            var selectedIndexPath : NSIndexPath = self.tableView.indexPathForSelectedRow!
            var destinationViewController : DetailViewController = (segue.destinationViewController as? DetailViewController)!
            destinationViewController.todoData = todoitems.objectAtIndex(selectedIndexPath.row)as! NSDictionary
